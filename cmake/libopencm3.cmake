...
if(CMAKE_HOST_WIN32)
     execute_process( COMMAND "cmd" "/c" ${LOCM3_DEVICE_SCRIPT} ${LOCM3_DEVICE_DATABASE} ${DEVICE} "CPPFLAGS" OUTPUT_VARIABLE LOCM3_DEVICE_DEFINES OUTPUT_STRIP_TRAILING_WHITESPACE)
     execute_process( COMMAND "cmd" "/c" ${LOCM3_DEVICE_SCRIPT} ${LOCM3_DEVICE_DATABASE} ${DEVICE} "CPU" OUTPUT_VARIABLE MCPU OUTPUT_STRIP_TRAILING_WHITESPACE)
     execute_process( COMMAND "cmd" "/c" ${LOCM3_DEVICE_SCRIPT} ${LOCM3_DEVICE_DATABASE} ${DEVICE} "FPU" OUTPUT_VARIABLE FPU_STR OUTPUT_STRIP_TRAILING_WHITESPACE)
     execute_process( COMMAND "cmd" "/c" ${LOCM3_DEVICE_SCRIPT} ${LOCM3_DEVICE_DATABASE} ${DEVICE} "DEFS" OUTPUT_VARIABLE DEVDEFS OUTPUT_STRIP_TRAILING_WHITESPACE)
     string(APPEND DEVDEFS " -P -E " ${LOCM3_LINKER_TEMPLATE} " " -o " " ${LOCM3_LINKER_GENERATED})
     separate_arguments(GEN_LD UNIX_COMMAND ${DEVDEFS})
     execute_process(COMMAND "cmd" "/c" ${CMAKE_C_COMPILER} ${GEN_LD})
else()
...
string(REPLACE stm32f stm32/f LOCM3_TARGET ${LOCM3_DEVICE_SERIE})
